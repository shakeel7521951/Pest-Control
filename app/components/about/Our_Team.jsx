const Our_Team = () => {
  ...
  return (
    <section className="relative -top-10 py-8 my-16 overflow-hidden bg-gradient-to-br from-green-100 to-blue-50 rounded-3xl mx-4 lg:mx-0">
      {/* Decorative elements */}
      ...
      <div className="container mx-auto px-6">
        <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-16">
          ...
          <div className="lg:w-1/2 lg:pr-8">
            <div className="mb-2 text-sm font-semibold text-green-500 uppercase tracking-wider">Our Experts</div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
              {teamMembers.map((member, index) => (
                ...
                >
                  ...
                  <p className="text-[#7BAE4B] font-medium mb-2 relative z-10">{member.role}</p>
                  <div className="flex items-center text-sm text-gray-500 mb-1 relative z-10">
                    <svg className="w-4 h-4 mr-1 text-[#7BAE4B]" fill="currentColor" viewBox="0 0 20 20">
