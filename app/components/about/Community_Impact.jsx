...
const Community_Impact = () => {
  ...
  return (
    <section className="relative py-10 top-12 verflow-hidden bg-gradient-to-br from-green-700 to-green-900 rounded-3xl">
      {/* Decorative elements */}
      ...
      <div className="container mx-auto px-6 text-center">
        ...
        <div className="max-w-3xl mx-auto mb-16">
          <h2 className="text-4xl md:text-5xl font-bold text-white mb-6">
            Our <span className="text-yellow-300">Community Impact</span>
          </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
          {stats.map((stat, index) => (
            ...
            >
              ...
              <div className="text-5xl font-bold text-white mb-2 group-hover:text-yellow-300 transition-colors duration-300">
                {stat.value}
              </div>
        ...
        {/* CTA button */}
        <button className="relative overflow-hidden group bg-yellow-400 hover:bg-yellow-300 text-green-900 font-bold px-10 py-4 rounded-full shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1">
          <span className="relative z-10">Join Our Community</span>
          <span className="absolute inset-0 bg-white opacity-0 group-hover:opacity-20 transition-opacity duration-500"></span>
          <span className="absolute -bottom-1 left-1/2 w-0 h-1 bg-yellow-500 group-hover:w-4/5 group-hover:left-1/10 transition-all duration-500"></span>
        </button>
        ...
        <div className="mt-16 max-w-2xl mx-auto bg-white/5 p-6 rounded-xl border border-white/10">
          ...
          <p className="text-yellow-300 font-medium">— Maria Sanchez, Avian Sanctuary Director</p>
        </div>
      </div>
    </section>
  )
